...
class Dynamask(AttributionMethod):
    ...
    Stub: uses finite-difference saliency as a proxy when the
    full Dynamask optimization is not available.
    """

    def __init__(self, n_steps: int = 100, lr: float = 0.05, lambda_sparsity: float = 0.1):
