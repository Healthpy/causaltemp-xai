...
10. [Causal and Counterfactual Explanations](https://www.emergentmind.com/topics/causal-and-counterfactual-explanations) — Emergent Mind
...
17. [Interventional Time Series Priors for Causal Foundation Models](https://arxiv.org/html/2603.11090v1) — arXiv
18. [Interventional Time Series Priors for Causal Foundation Models (PDF)](https://arxiv.org/pdf/2603.11090) — arXiv
19. [Explainable AI: Learning from the Learners](https://arxiv.org/html/2601.05525v2) — arXiv
20. [Causal inference for time series](https://causalinferencelab.com/wp-content/uploads/2023/06/Runge_Causal_Inference_for_Time_Series_NREE.pdf)
...
28. [CaNDiCE: Causal Discovery of Nonlinear Dynamics Through Constraints](https://openreview.net/forum?id=bgdTK6cniJ) — OpenReview
...
31. [Temporal Causal-based Simulation for Realistic Time-series Generation](https://arxiv.org/html/2506.02084v1) — arXiv
32. [GitHub — gkorgkolis/TCS: Temporal Causal-based Simulation (TCS)](https://github.com/gkorgkolis/TCS)
33. [What-If Explanations Over Time: Counterfactuals for Time Series Classification](https://arxiv.org/abs/2603.27792) — arXiv
34. [CounterBench: A Benchmark for Counterfactuals Reasoning in Large Language Models](https://arxiv.org/html/2502.11008v1)
...
36. [STAA: Spatio-Temporal Attention Attribution for Real-Time Interpreting Transformer-based AI Video Models](https://www.researchgate.net/publication/392352868_STAA_Spatio-Temporal_Attention_Attribution_for_Real-Time_Interpreting_Transformer-based_AI_Video_Models) — ResearchGate
37. [Counterfactual Explanations via Latent Structure for Time Series Classification](https://openreview.net/forum?id=oKUjFiuoVi) — OpenReview
38. [Controllable Sequence Editing for Counterfactual Generation](https://zitniklab.hms.harvard.edu/projects/CLEF/) — Zitnik Lab
...
41. [Plausible Counterfactual Explanations for Multivariate Time-Series Forecast through Genetic Algorithms](https://arxiv.org/html/2603.00855v1) — arXiv
42. [Synthetic Causal Priors for In-Context Time-Series Classification](https://openreview.net/forum?id=nMRrgMF2S8) — OpenReview
43. [Beyond Task-Specific Classifiers: In-Context Inference for Time Series Classification Foundation Models](https://openreview.net/forum?id=HVvARHEA9M) — OpenReview
