"""
Exact abduction (Pearl's Step 1 of the causal ladder).

Ported from causal_tscf_bench/causal_tscf_bench/scm/abduction.py.
...
def abduct(
    ...
    ----------
    X : np.ndarray
        Shape (N, T, k) or (T, k) for a single instance.
    dag : LaggedDAG
    mechanisms : list[Mechanism]
